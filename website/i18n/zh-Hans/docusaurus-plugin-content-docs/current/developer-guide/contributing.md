...
- **Profile 安全路径**：不得硬编码 `~/.clara` — 代码路径使用 `clara_constants` 中的 `get_clara_home()`，面向用户的消息使用 `display_clara_home()`。完整规则参见 [AGENTS.md](https://github.com/claragram/clara-agent/blob/main/AGENTS.md#profiles-multi-instance-support)。
...
- 使用 [GitHub Issues](https://github.com/claragram/clara-agent/issues)
...
提交贡献即表示您同意您的贡献将以 [MIT 许可证](https://github.com/claragram/clara-agent/blob/main/LICENSE) 授权。