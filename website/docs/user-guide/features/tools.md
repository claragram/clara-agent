...
Paid [Clara Portal](https://portal.claraship.com) subscribers can use web search, image generation, TTS, and browser automation through the **[Tool Gateway](tool-gateway.md)** — no separate API keys needed. Run `clara model` to enable it, or configure individual tools with `clara tools`.
:::
