...
See the [config reference](https://github.com/claragram/clara-agent/blob/main/plugins/memory/honcho/README.md) and [Honcho integration guide](https://docs.honcho.dev/v3/guides/integrations/clara).
...
See [plugin README](https://github.com/claragram/clara-agent/blob/main/plugins/memory/hindsight/README.md) for the full configuration reference.
