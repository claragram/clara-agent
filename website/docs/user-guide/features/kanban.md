...
[`agent-merge-conflict-arbiter` optional skill](https://github.com/claraship/clara-agent/blob/main/optional-skills/autonomous-ai-agents/agent-merge-conflict-arbiter/SKILL.md)
...
guide](https://github.com/claraship/clara-agent/blob/main/docs/kanban/multi-gateway.md)),
