...
| | |
|---|---|
| Source | Optional — install with `clara skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain\hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Clara Agent |
| License | MIT |
...
The script reads `${CLARA_HOME:-~/.clara}/.env` for two optional defaults:
...
Helper script: `~/.clara/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/.clara/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${CLARA_HOME:-~/.clara}/.env`.
...
```bash
python ~/.clara/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.clara/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
