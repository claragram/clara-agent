...
| | |
|---|---|
| Source | Optional — install with `clara skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain\solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Clara Agent |
| License | MIT |
...
Helper script path: ~/.clara/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.clara/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.clara/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.clara/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.clara/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.clara/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.clara/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
