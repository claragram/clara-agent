...
| | |
|---|---|
| Source | Optional — install with `clara skills install official/web-development/page-agent` |
...
- User wants **Clara itself to drive a browser** → use Clara' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
