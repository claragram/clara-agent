...
| | |
|---|---|
| Source | Optional — install with `clara skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing clara tool access (web_search, file ops). Stateless. |
