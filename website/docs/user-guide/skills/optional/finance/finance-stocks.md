...
| | |
|---|---|
| Source | Optional — install with `clara skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Clara Agent |
| License | MIT |
...
```
python ~/.clara/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
