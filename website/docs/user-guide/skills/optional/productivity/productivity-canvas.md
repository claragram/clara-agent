...
| | |
|---|---|
| Source | Optional — install with `clara skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Clara Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${CLARA_HOME:-~/.clara}/.env`:
