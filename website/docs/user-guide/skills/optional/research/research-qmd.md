...
| | |
|---|---|
| Source | Optional — install with `clara skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`clara-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-clara-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Clara Agent via the native MCP client. This is the preferred
...
Then configure Clara Agent to connect via HTTP:
