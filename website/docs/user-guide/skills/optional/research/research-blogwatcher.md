...
| | |
|---|---|
| Source | Optional — install with `clara skills install official/research/blogwatcher` |
...
## Working with Clara tools (read this first)

`blogwatcher-cli` is the feed database; Clara tools do the automation around it:
