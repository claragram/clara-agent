...
| | |
|---|---|
| Source | Optional — install with `clara skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research\darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Clara Agent |
| License | MIT |
...
import upstream classes into Clara itself.
...
Open `~/.clara/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Clara core.
   Custom driver scripts under `~/.clara/skills/...` are user-side and fine.
