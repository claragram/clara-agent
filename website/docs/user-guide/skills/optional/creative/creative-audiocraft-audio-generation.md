...
| | |
|---|---|
| Source | Optional — install with `clara skills install official/creative/audiocraft-audio-generation` |
...
- **[Advanced Usage](https://github.com/claraprise/clara-agent/blob/main/optional-skills/creative\audiocraft-audio-generation/references/advanced-usage.md)** - Training, fine-tuning, deployment
- **[Troubleshooting](https://github.com/claraprise/clara-agent/blob/main/optional-skills/creative\audiocraft-audio-generation/references/troubleshooting.md)** - Common issues and solutions
