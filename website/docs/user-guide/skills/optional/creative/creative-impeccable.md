...
| | |
|---|---|
| Source | Optional — install with `clara skills install official/creative/impeccable` |
...
> ships and verifies a Clara-native skill bundle under `.clara/skills/`.
> `clara skills install impeccable` pulls the current bundle live from that
