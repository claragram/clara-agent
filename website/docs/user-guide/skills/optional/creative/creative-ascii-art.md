...
| | |
|---|---|
| Source | Optional — install with `clara skills install official/creative/ascii-art` |
| Path | `optional-skills/creative\ascii-art` |
| Version | `4.0.0` |
| Author | 0xbyt4, Clara Agent |
| License | MIT |
...
```bash
python -m pyfiglet "CLARA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=CLARA&font=Slant" | boxes -d stone
```
