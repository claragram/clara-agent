...
| | |
|---|---|
| Source | Optional — install with `clara skills install official/creative/tldraw-offline` |
| Path | `optional-skills/creative\tldraw-offline` |
| Version | `1.0.0` |
| Author | Teknium + Clara Agent |
| License | MIT |
...
- **Agent skills installed in the app**: `Develop → Install Agent Skills`. The
  ...
  recipes below. (This Clara skill mirrors that guidance for Clara.)
