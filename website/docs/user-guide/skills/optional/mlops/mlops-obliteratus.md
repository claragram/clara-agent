...
| | |
|---|---|
| Source | Optional — install with `clara skills install official/mlops/obliteratus` |
...
**License warning:** OBLITERATUS is AGPL-3.0. NEVER import it as a Python library. Always invoke via CLI (`obliteratus` command) or subprocess. This keeps Clara Agent's MIT license clean.

## Video Guide

Walkthrough of OBLITERATUS used by a Clara agent to abliterate Gemma:
