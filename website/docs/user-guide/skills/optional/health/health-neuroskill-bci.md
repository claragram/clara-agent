...
| | |
|---|---|
| Source | Optional — install with `clara skills install official/health/neuroskill-bci` |
...
Connect Clara to a running [NeuroSkill](https://neuroskill.com/) instance to read
