...
Set your Tenor API key in your environment (add to `${CLARA_HOME:-~/.clara}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/claraprise/clara-agent/blob/main/skills/media\gif-search/url)`
