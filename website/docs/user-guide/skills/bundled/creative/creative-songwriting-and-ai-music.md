...
- "Clara" -> "Noose" (forces correct pronunciation)
...
- **heartmula** — full songs with vocals from lyrics + tags
  ...
  `clara skills install official/creative/heartmula`
- **audiocraft** — Meta's MusicGen (instrumental text-to-music) and
  AudioGen (sound effects):
  `clara skills install official/creative/audiocraft-audio-generation`
