...
Download the app from the [Clara Desktop product page](https://workprise.fr/desktop), or follow the [installation instructions for Clara Desktop](../getting-started/installation.md).
...
The [manual update process](https://workprise.fr/docs/getting-started/updating) also works with the GUI.
