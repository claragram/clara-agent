...
Don't have a subscription yet? [portal.claraprise.com/manage-subscription](https://portal.claraprise.com/manage-subscription) — sign up, then come back and run the command above.
...
1. Opens your browser to portal.claraprise.com for OAuth login
...
If you don't have a subscription yet, sign up at [portal.claraprise.com/manage-subscription](https://portal.claraprise.com/manage-subscription) first.
...
- **Web:** [portal.claraprise.com/manage-subscription](https://portal.claraprise.com/manage-subscription)
...
If a model is genuinely missing, [open an issue](https://github.com/claraprise/clara-agent/issues) — we surface the Portal's catalog to Clara and gaps usually mean a routing config we can update.
