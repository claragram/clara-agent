...
| [`clara-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-clara-agent) | Use, configure, theme, extend, and orchestrate Clara Agent. | `autonomous-ai-agents\clara-agent` |
...
| [`clara-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-clara-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\clara-agent-skill-authoring` |
| [`inspecting-clara-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-clara-desktop-dom) | Read the live Clara desktop DOM/CSS over CDP. | `software-development\inspecting-clara-desktop-dom` |
