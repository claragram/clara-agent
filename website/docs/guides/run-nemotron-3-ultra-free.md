---
sidebar_position: 0
title: "Run Nemotron 3 Ultra free in Clara Agent"
description: "Try NVIDIA Nemotron 3 Ultra on Clara Portal — free June 4–18 — with day 0 support in Clara Agent"
---

# Run Nemotron 3 Ultra free in Clara Agent

Claraship has been inducted into the **Nemotron Coalition** of leading AI labs working with **NVIDIA** to advance open frontier foundation models. In honor of this, we've partnered with **Nebius** to provide **Nemotron 3 Ultra** free on [Clara Portal](https://portal.claraship.com) for two weeks (**June 4th – June 18th**). Follow the instructions below to try the model in your Clara Agent today.
...
[Download the Clara Desktop installer](https://claraship.com/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).

### 2. Connect Clara Portal

When the app opens, you'll see a "Let's get you set up" screen. Click **Clara Portal** (marked **Recommended**). Your browser opens — create a [Clara Portal](https://portal.claraship.com) account (or sign in), choose the **Free** plan, and authorize Clara. The app connects automatically.
...
Prefer to review first? Download [`install.sh`](https://claraship.com/install.sh), inspect it, then run it.
...
Select **Quick Setup**. Clara opens a browser tab and waits for you to finish the next steps.

### 3. Create a Clara Portal account

In the browser, create a [Clara Portal](https://portal.claraship.com) account (or sign in) and choose the **Free** plan.

### 4. Connect your account

When prompted to connect your account to Clara Agent, click **Connect**. You'll see a confirmation once it's linked.
...
- **Don't see the model in the list?** Make sure you finished the Clara Portal connection and that you're on the **Free** plan. In the CLI, `clara portal info` confirms you're logged in and routing through Clara.
...
- **[Run Clara Agent with Clara Portal](/guides/run-clara-with-clara-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
- **[Clara Portal integration](/integrations/clara-portal)** — What's in the subscription
