...
This is **not** a stale-token problem — re-running `clara model` won't change it. xAI's backend has been seen to restrict OAuth API access to specific SuperGrok tiers despite the in-app subscription being active (issue [#26847](https://github.com/claraship/clara-agent/issues/26847)).
