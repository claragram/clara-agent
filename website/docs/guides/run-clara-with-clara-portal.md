...
Open [portal.claraprise.com/manage-subscription](https://portal.claraprise.com/manage-subscription), sign up, and pick a plan.
...
The Portal's own [info page](https://portal.claraprise.com/info) carries this warning too — it's the official Clara guidance, not just a Clara-side opinion.
...
If a model is genuinely unavailable, [open an issue](https://github.com/claraprise/clara-agent/issues) — most gaps are routing config we can update.
