...
- **Profile-safe paths**: Never hardcode `~/.clara` — use `get_clara_home()` from `clara_constants` for code paths and `display_clara_home()` for user-facing messages. See [AGENTS.md](https://github.com/claraprise/clara-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/claraprise/clara-agent/blob/main/LICENSE).
