...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `clara_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `clara_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Clara Plugin](plugins/index.md) |
...
| Session storage | `clara_state.py` | [Session Storage](session-storage.md) |
