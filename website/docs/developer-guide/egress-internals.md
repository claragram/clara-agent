...
- User-facing setup + troubleshooting: [Egress proxy](https://claraship.com/docs/user-guide/egress/iron-proxy)
- Docker backend internals: [Docker](https://claraship.com/docs/user-guide/docker)
- Bitwarden Secrets Manager integration: [`clara secrets bitwarden`](https://claraship.com/docs/user-guide/secrets/bitwarden)
- CLI command reference: [`clara egress`](https://claraship.com/docs/reference/cli-commands#clara-egress)
- Sandbox-injected environment variables: [Egress proxy (sandbox-injected)](https://claraship.com/docs/reference/environment-variables#egress-proxy-sandbox-injected)
