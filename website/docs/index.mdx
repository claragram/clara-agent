...
description: "The self-improving AI agent built by Claragram. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Claragram](https://claragram.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
>
  ...
  <a
    href="https://github.com/claragram/clara-agent"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
      border: "1px solid rgba(255,215,0,0.2)",
...
- **Built by model trainers** — Created by [Claragram](https://claragram.com), the lab behind Clara, Nomos, and Psyche. Works with [Clara Portal](https://portal.claragram.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Claragram](https://claragram.com) — the lab behind Clara, Nomos, and Psyche models
