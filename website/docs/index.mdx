...
slug: /
sidebar_position: 0
title: "Clara Agent Documentation"
description: "The self-improving AI agent built by Claraship. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Claraship](https://claraship.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
>
  ...
  <a
    href="/docs/downloads/Claraship-mac-arm64.dmg"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
      border: "1px solid rgba(255,215,0,0.2)",
  ...
  >
    Download Desktop (.dmg)
  </a>
  <a
    href="https://github.com/claraship/clara-agent"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
      border: "1px solid rgba(255,215,0,0.2)",
...
After installing, run `clara setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Clara Portal](/integrations/clara-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Clara safely  |
| 🧭 **[Use MCP with Clara](/guides/use-mcp-with-clara)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Clara](/guides/use-voice-mode-with-clara)** | Hands-on setup and usage patterns for Clara voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Clara' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Clara                              |
...
- **Built by model trainers** — Created by [Claraship](https://claraship.com), the lab behind Clara, Nomos, and Psyche. Works with [Clara Portal](https://portal.claraship.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [Clara Portal](/integrations/clara-portal) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Claraship](https://claraship.com) — the lab behind Clara, Nomos, and Psyche models
