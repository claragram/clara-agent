...
description: "The self-improving AI agent built by Workprise. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Workprise](https://workprise.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
- **Built by model trainers** — Created by [Workprise](https://workprise.com), the lab behind Clara, Nomos, and Psyche. Works with [Clara Portal](https://portal.claraprise.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Workprise](https://workprise.com) — the lab behind Clara, Nomos, and Psyche models
