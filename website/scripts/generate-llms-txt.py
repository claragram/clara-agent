#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Clara docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Clara as a Python Library", None),
        ("guides/use-mcp-with-clara", "Use MCP with Clara", None),
        ("guides/use-voice-mode-with-clara", "Use Voice Mode with Clara", None),
        ("guides/use-soul-with-clara", "Use SOUL.md with Clara", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Clara"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "backends. Works with Clara Portal, OpenRouter, OpenAI, Anthropic, Google, or any "
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Clara Agent — Full Documentation\n",
        (
            "This file is the entire Clara Agent documentation concatenated for LLM "
