 ...
 *
 * Clara Desktop signs with ``hardenedRuntime: true`` and points
...
test('bootstrap installer carries microphone entitlement for launcher attribution', () => {
  ...
  assert.equal(
    ...
    'the macOS bootstrap installer must sign with its entitlements.plist. ' +
      'When /Applications/Clara.app is the setup launcher, macOS TCC treats ' +
      'com.claraship.clara.setup as the responsible process for the desktop ' +
