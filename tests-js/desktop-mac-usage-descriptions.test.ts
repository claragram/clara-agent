 ...
 *
 * Each entry is a key/value pair that lands in the packaged Clara.app's
 ...
 * "Clara wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Clara wants to access Music" when Clara never touches the Music
