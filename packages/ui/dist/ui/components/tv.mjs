...
export function TV({ className }) {
  ...
  useGL(canvasRef);
  return /* @__PURE__ */ React.createElement("div", { className: ["relative", className].filter(Boolean).join(" ") }, /* @__PURE__ */ React.createElement("svg", { className: "relative h-full w-full", fill: "none", viewBox: "0 0 210 173" }, /* @__PURE__ */ React.createElement(
    "path",
    {
