...
export function FilterGroup({ children, className, label }) {
  return /* @__PURE__ */ React.createElement("div", { className: cn("flex items-center gap-2", className) }, /* @__PURE__ */ React.createElement("span", { className: "font-mondwest text-display text-xs tracking-[0.12em] text-text-tertiary" }, label), children);
}
