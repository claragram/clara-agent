...
export function BottomSheet({
  ...
  return createPortal(
    /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-[200] flex flex-col justify-end" }, /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ React.createElement("div", { className: "min-h-0 flex-1 overflow-y-auto overscroll-contain" }, children)
    )),
    document.body
  );
}
