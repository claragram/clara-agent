...
export function GearIcon({
  ...
  return /* @__PURE__ */ React.createElement("svg", { fill: "none", viewBox: VIEWBOX, ...props }, /* @__PURE__ */ React.createElement("g", { clipRule: "evenodd", fill: "currentColor", fillRule: "evenodd" }, /* @__PURE__ */ React.createElement("path", { d: GEAR_PATH })), children && /* @__PURE__ */ React.createElement(
    "svg",
    {
