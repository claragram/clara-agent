...
export function Cursor({ scale = 0.8 }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { ref: $arrow, style: { inset: 0, position: "absolute" } }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 16 16" }, /* @__PURE__ */ React.createElement(
      "path",
      {
    ...
    /* @__PURE__ */ React.createElement("div", { ref: $ptr, style: { inset: 0, opacity: 0, position: "absolute" } }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 28 29" }, /* @__PURE__ */ React.createElement(
      "path",
      {
        d: HAND,
        fill: "#fff",
