...
export function Select({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("span", { className: cn("truncate", !selected && "text-midground/50") }, displayLabel),
      /* @__PURE__ */ React.createElement(
        ChevronDownGlyph,
        {
          className: cn(
    ...
    open && /* @__PURE__ */ React.createElement("div", { className: LISTBOX_CN, ref: listRef, role: "listbox" }, options.map((opt, i) => {
...
const ChevronDownGlyph = ({ className }) => /* @__PURE__ */ React.createElement(
  "svg",
  {
    "aria-hidden": true,
    className,
  ...
  /* @__PURE__ */ React.createElement("path", { d: "M2.5 4.5 6 8l3.5-3.5" })
);
const CheckGlyph = ({ className }) => /* @__PURE__ */ React.createElement(
  "svg",
  {
    "aria-hidden": true,
    className,
  ...
  /* @__PURE__ */ React.createElement("path", { d: "m2.5 6.5 2.5 2.5L9.5 3.5" })
);
