...
const IconSlot = ({
  icon,
  side
}) => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { className: "w-5" }), /* @__PURE__ */ React.createElement(
  "span",
  {
    className: cn(
  ...
  typeof icon === "object" ? cloneElement(icon, {
    className: "size-3.5"
  }) : icon
));
export const Button = ({
  ...
  !ghost && /* @__PURE__ */ React.createElement(
    "span",
    {
      "aria-hidden": true,
  ...
  prefix && /* @__PURE__ */ React.createElement(IconSlot, { icon: prefix, side: "left" }),
  children,
  suffix && /* @__PURE__ */ React.createElement(IconSlot, { icon: suffix, side: "right" })
);
