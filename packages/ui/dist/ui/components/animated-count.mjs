...
export function AnimatedCount({
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("svg", { className: "pointer-events-none absolute size-0" }, /* @__PURE__ */ React.createElement("defs", null, digits.map((_, i) => /* @__PURE__ */ React.createElement(
    "filter",
    {
  ...
  )))), /* @__PURE__ */ React.createElement("span", { className: "inline-flex tabular-nums" }, digits.map((c, i) => /* @__PURE__ */ React.createElement(
    "span",
    {
