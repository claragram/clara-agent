...
export const Checkbox = forwardRef(function Checkbox2({ className, ...props }, ref) {
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(CheckboxPrimitive.Indicator, { className: "flex items-center justify-center text-current" }, /* @__PURE__ */ React.createElement(CheckIcon, { className: "h-3 w-3 text-midground" }))
  );
});
