...
export function Shader({
  ...
  if (typeof children === "function") {
    return children(/* @__PURE__ */ React.createElement("shaderMaterial", { ...materialProps }));
  }
  return /* @__PURE__ */ React.createElement("mesh", { ...props }, children ?? /* @__PURE__ */ React.createElement("planeGeometry", null), /* @__PURE__ */ React.createElement("shaderMaterial", { ...materialProps }));
}
