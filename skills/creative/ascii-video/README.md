...
Built for [Clara Agent](https://github.com/claraship/clara-agent). Usable in any coding agent. Canonical source lives here; synced to [`claraship/clara-agent/skills/creative/ascii-video`](https://github.com/claraship/clara-agent/tree/main/skills/creative/ascii-video) via PR.
