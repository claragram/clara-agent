...
Built for [Clara Agent](https://github.com/claragram/clara-agent). Usable in any coding agent. Canonical source lives here; synced to [`claragram/clara-agent/skills/creative/ascii-video`](https://github.com/claragram/clara-agent/tree/main/skills/creative/ascii-video) via PR.
