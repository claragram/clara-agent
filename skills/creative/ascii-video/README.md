...
Built for [Clara Agent](https://github.com/claraprise/clara-agent). Usable in any coding agent. Canonical source lives here; synced to [`Workprise/clara-agent/skills/creative/ascii-video`](https://github.com/claraprise/clara-agent/tree/main/skills/creative/ascii-video) via PR.
