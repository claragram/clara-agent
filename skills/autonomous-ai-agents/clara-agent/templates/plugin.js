/**
 * Clara desktop plugin template. Save as:
 *   <clara home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <clara home> is ~/.clara by default, or ~/.clara/profiles/<name>
 * when running a named profile (`clara -p <name>`). Run `clara doctor` (or
 ...
 * Only these imports resolve: @clara/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@clara/plugin-sdk'
