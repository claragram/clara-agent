...
def build_auth_parser(subparsers, *, cmd_auth: Callable) -> None:
    ...
    auth_add.add_argument("--portal-url", help="Clara portal base URL")
    auth_add.add_argument("--inference-url", help="Clara inference base URL")
    ...
    auth_spotify = auth_subparsers.add_parser(
        "spotify", help="Authenticate Clara with Spotify via PKCE"
    )
    ...
    auth_spotify.add_argument(
        "--client-id", help="Spotify app client_id (or set CLARA_SPOTIFY_CLIENT_ID)"
    )
    auth_spotify.add_argument(
        "--redirect-uri",
