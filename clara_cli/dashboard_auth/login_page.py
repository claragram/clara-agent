...
``@workprise/ui`` package the React dashboard uses): the same
...
``tests/clara_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<style>
  /* Brand fonts shipped by @workprise/ui — same files the SPA loads. */
  @font-face {{
...
<body>
<main>
  <div class="brand">Clara<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Clara Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Clara Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
