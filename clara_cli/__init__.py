"""
Clara CLI - Unified command-line interface for Clara Agent.

Provides subcommands for:
- clara chat          - Interactive chat (same as ./clara)
- clara gateway       - Run gateway in foreground
- clara gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `clara setup` on a fresh Pi.
    ...
    clara_cli/stdio.py::configure_windows_stdio() runs later from the entry
