"""Relay subscriber for the persisted Clara shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Clara counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Clara shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
