...
#: CLARA_* env vars for secrets, and a behavioural override here would be a
#: consent hazard — a user who agreed to send metrics to Clara could have them
...
DEFAULT_ENDPOINT = "https://telemetry.claraship.com/v1/telemetry"
