"""Transmit exported shared-metrics packages to the Clara telemetry service.
...
def _post(endpoint: str, payload: bytes, *, timeout: int) -> _Response:
    ...
    headers = {
        ...
        "User-Agent": "clara-agent-shared-metrics/1",
    }
    body = payload
...
def reconcile_send_consent(
    ...
    *,
    ...
    harness in tests/clara_cli/test_shared_metrics_consent_windows.py):
