...
Invoked by ``clara kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Clara Agent board.
...
def _profile_author() -> str:
    """Mirror of ``clara_cli.kanban._profile_author``."""
    return (
