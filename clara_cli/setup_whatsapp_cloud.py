...
Entry point: ``clara whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``clara_cli/main.py``).
...
Clara gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Clara to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Clara needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Clara gateway in another terminal:")
    print("         clara gateway")
    print()
    ...
    print()
    print("  Docs: https://agent.claraprise.com/docs/user-guide/")
