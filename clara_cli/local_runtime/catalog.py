...
_CATALOG_URL = ("https://raw.githubusercontent.com/claraship/clara-agent"
...
def _packaged_catalog() -> "tuple[CatalogEntry, ...]":
    ...
    raw = files("clara_cli.local_runtime").joinpath("catalog.json").read_text(
        encoding="utf-8")
...
def refresh_catalog(force: bool = False) -> bool:
    ...
    try:
        req = urllib.request.Request(
            _CATALOG_URL, headers={"User-Agent": "clara-local-runtime"})
