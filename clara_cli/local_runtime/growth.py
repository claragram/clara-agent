...
session reaches the edge of its granted window, Clara grows the window
...
new window and re-prefills the conversation. Nothing about the Clara
...
def maybe_grow_window(model_id: str, *, base_url: str, session_tokens: int,
    ...
    from clara_cli.local_runtime.estimator import profile_from_gguf
    from clara_cli.local_runtime.gguf import read_gguf_header
