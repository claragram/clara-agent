...
1. the managed server this Clara is supervising (state file written by
...
def _state_endpoint() -> dict | None:
    ...
    # CLARA_HOME — a scratch profile, say) can own 127.0.0.1:18434 with a
...
def resolve_llamacpp_endpoint(config: dict | None = None,
    ...
    from clara_cli.local_runtime.detect import detect_server
