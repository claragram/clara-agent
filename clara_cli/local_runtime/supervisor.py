...
from clara_cli.local_runtime.binaries import server_binary, runtimes_root
...
def state_path() -> Path:
    """Endpoint state for other Clara processes (provider resolution reads
...
class LlamaServerSupervisor:
    """Own one llama-server router process for the life of a Clara session.
