"""Shared curses-based UI components for Clara CLI.

Used by `clara tools` and `clara skills` for interactive checklists.
...
_MENU_NAVIGATION_HANDLER: ContextVar[MenuNavigationHandler | None] = ContextVar(
    "clara_menu_navigation_handler", default=None
)
_NUMBERED_BACK_ENABLED: ContextVar[bool] = ContextVar(
    "clara_numbered_back_enabled", default=False
)
