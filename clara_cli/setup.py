...
_DOCS_BASE = "https://agent.claraship.com/docs"
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://agent.claraship.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://agent.claraship.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
...
def _run_portal_one_shot(config: dict) -> None:
    ...
    print()
    print_info("  Sign up: https://portal.claraship.com/manage-subscription")
    print()
