#!/usr/bin/env python3
"""
SWE Runner with Clara Trajectory Format

A runner that uses Clara-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Clara-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Clara-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Clara format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Clara-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Clara-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Clara Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Clara-Agent's built-in execution environments
    and outputs trajectories in Clara-Agent format.
    """
    ...
    def _convert_to_clara_format(
        ...
        """
        Convert internal message format to Clara trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Clara trajectory format
        trajectory = self._convert_to_clara_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Clara trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Clara Trajectory Format")
    print("=" * 60)
