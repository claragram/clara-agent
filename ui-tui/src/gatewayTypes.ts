import type { BillingBlock, UsageModelData } from '@clara/shared/billing'
import type { ClaraSkin } from '@clara/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@clara/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = ClaraSkin
...
// Wire shapes now live in @clara/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
