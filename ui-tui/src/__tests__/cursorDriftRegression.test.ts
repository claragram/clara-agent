 ...
 *
 * Symptom: in `clara --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@clara/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using clara --tui and as i type multiline my caret at the end will often ' +
