import { Box, type ScrollBoxHandle, stringWidth, Text } from '@clara/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (CLARA_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (CLARA_DEV_CREDITS), lowest priority,
