...
function ConfirmScreen({
  ...
  return (
    <Box flexDirection="column">
      ...
      <Text color={t.color.muted}>By confirming, you allow Claraship to charge your card.</Text>
      <Text />
...
function AutoReloadScreen({ ctx, onClose, onPatch, s, t }: ScreenProps) {
  ...
  return (
    <Box flexDirection="column">
      ...
      <Text />
      <Text color={t.color.muted}>
        By confirming, you authorize Claraship to charge {chargeCardName} whenever your balance falls below the
