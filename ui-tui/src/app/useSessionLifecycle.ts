...
import type { ScrollBoxHandle } from '@clara/ink'
import { evictInkCaches } from '@clara/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.CLARA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
