 ...
 * across theme x background scenes to <tmpdir>/clara-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@clara/ink'
...
// The regenerated slate light_colors block from clara_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/clara-agent',
...
const setup = (bgHex: string) => {
  process.env.CLARA_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
