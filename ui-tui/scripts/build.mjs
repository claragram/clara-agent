...
await build({
  ...
  // Skip the prebuilt @clara/ink bundle and inline the source instead:
  ...
  alias: { '@clara/ink': resolve(root, 'packages/clara-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The clara_cli launcher
