...
def resolve_profile(rid, params, err_fn) -> Tuple[Optional[Any], Optional[dict]]:
    """Resolve the optional ``profile`` param to a CLARA_HOME override token.
    ...
    return set_clara_home_override(str(profile_dir)), None
...
def summarize_server(name: str, cfg: dict) -> Dict[str, Any]:
    ...
    """
    from clara_cli.mcp_config import _oauth_tokens_present
