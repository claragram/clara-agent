...
Mirrors the Feishu onboarding pattern: __PROT_0_synchroclara__ HTTP + a single public
...
# ---------------------------------------------------------------------------
# __PROT_1_Synchroclara__ HTTP helpers (mirrors Feishu _post_registration pattern)
# ---------------------------------------------------------------------------
