...
class RelayAdapter(BasePlatformAdapter):
    ...
    def _start_revocation_monitor(self) -> None:
        ...
        try:
            ...
            # No running loop (e.g. a unit test calling connect() __PROT_0_synchroclaraly__
    ...
    def _relay_slack_extra(self) -> Dict[str, Any]:
        ...
        Enterprise knob shape (Clara-config directed, relay-namespaced):
    ...
    def _slack_unfurl_hints(self, platform: Optional[str]) -> Optional[Dict[str, bool]]:
        ...
        for knob in ("unfurl_links", "unfurl_media"):
            ...
            if val is None:
                continue
            # Railway / `clara config set` write YAML strings ("true"/"false").
        ...
        try:
            ...
            if platform == "discord":
                ...
                if event is not None:
                    self._capture_scope(event)
                    # Phase 3: a component press carrying a Clara prompt token
    ...
    def _discord_interaction_to_event(self, forward):
        ...
        source = SessionSource(
            ...
            # The CLARA profile this interaction is routed to (multiplex
        ...
        if itype == 3:
            # Phase 3: a component press whose custom_id is a Clara prompt
    ...
    def _decode_prompt_token(token: str):
        ...
        — and is not — a Clara prompt answer.
        """
        import re
    ...
    def _resolve_reply_to_for_send(
        ...
        Native Slack Clara already suppresses this synthetic DM thread anchor:
    ...
    async def _send_prompt(
        ...
        *,
        ...
        # Clara suppresses this synthetic DM thread anchor; drop it here for the
