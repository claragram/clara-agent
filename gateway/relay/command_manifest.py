...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Clara session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Clara session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Clara agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Clara Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Clara gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Clara session in it",
