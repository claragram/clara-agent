...
Hooks are discovered from ~/.clara/hooks/ directories, each containing:
...
HOOKS_DIR = get_clara_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"clara_hook_{hook_name}"
