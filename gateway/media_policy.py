...
from environment variables:
  ...
  - ``CLARA_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``CLARA_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``CLARA_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``clara cron run`` in the CLI, ``clara send``, a
...
_STRICT_ENV = "CLARA_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "CLARA_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "CLARA_MEDIA_TRUST_RECENT_FILES"
