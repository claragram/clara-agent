...
Bridges the __PROT_0_synchroclara__ agent ``stream_delta_callback`` (fired from the
...
Design:
- ``on_delta`` is __PROT_1_synchroclara__ and never blocks the agent thread. It feeds
