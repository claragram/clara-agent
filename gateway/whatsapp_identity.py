...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$CLARA_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_clara_dir("platforms/whatsapp/session", "whatsapp/session")
