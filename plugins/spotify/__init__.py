...
``_check_spotify_available()`` — when the user has not run ``clara auth
spotify``, the tools remain registered (so they appear in ``clara
...
The Spotify auth flow (``clara auth spotify``), CLI plumbing, and docs
