...
two endpoints so a fresh Clara install with **zero web credentials** still
...
def provider_tier(name: str) -> str:
    ...
    ``clara tools`` picker's Free/Paid rows). ``free`` forces the keyless
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "backend via `clara tools` for reliable service."
            ),
        }
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "via `clara tools` for reliable service."
            ),
        }
