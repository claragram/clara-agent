...
Configuration
-------------
Secret (lives in $CLARA_HOME/.env or the environment):
...
Behavioral settings (live in $CLARA_HOME/mem0.json, set via `clara memory
setup`):
  ...
  agent_id           — Agent identifier (default: clara)
...
def _load_config() -> dict:
    """Load config from env vars, with $CLARA_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "clara"),
        "oss": {},
    }
    ...
    config_path = get_clara_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, clara_home):
        """Write config to $CLARA_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $CLARA_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "clara")
