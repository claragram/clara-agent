...
Config: ~/.clara/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.clara/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_clara_home()`` helper (CLARA_HOME-aware and
...
RULES_FILE = get_clara_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_clara_home() / "feishu_comment_pairing.json"
