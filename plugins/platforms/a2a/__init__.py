"""
A2A (Agent-to-Agent) plugin for Clara Agent.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes Clara as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`clara gateway setup` flow for A2A."""
    ...
    print_info("Expose Clara as an A2A-discoverable agent and call other A2A agents.")
