...
required — uses aiohttp which is already a Clara dependency.
...
def interactive_setup() -> None:
    ...
    ``clara_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Clara delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # clara_cli/setup.py::_setup_mattermost function.
