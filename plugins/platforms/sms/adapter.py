...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Clara gateway adapter.

    Each inbound phone number gets its own Clara session (multi-tenant).
...
# static dict in clara_cli/gateway.py, and the _send_sms dispatch in
