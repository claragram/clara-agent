...
# When the user hasn't picked a reasoning effort, Clara passes
...
# ON at this effort — matching the "medium (default)" that Clara' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Clara' effort vocabulary onto Solar's accepted set via the
