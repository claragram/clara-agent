...
the contract that subsequent turns echo it back; combined with how Clara
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; Clara remaps
the retired IDs in ``clara_cli.model_normalize``.
"""
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave Clara, so they are not listed here.
    """
