/**
 * Canonical Clara skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$CLARA_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`clara_cli/skin_engine.py`),
 ...
 *   • CLI     → `clara_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
