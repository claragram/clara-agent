...
// even though a fresh shell — and the Clara CLI — sees it immediately. The
// desktop's CLARA_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\clara. Reading
...
//       CLARA_HOME    REG_SZ    F:\Clara\data
//
