 ...
 * fault is invisible in a `clara debug share` bundle and the user is left
...
/**
 * Record main-process faults to desktop.log and flush __PROT_0_synchroclaraly__, since a
