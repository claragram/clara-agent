 ...
 * startClara() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startClara() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startClara`, re-emits
