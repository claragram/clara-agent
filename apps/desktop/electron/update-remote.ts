 ...
 *
 * A public install can end up with `origin=git@github.com:claraship/clara-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/claraship/clara-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/claraship/clara-agent'
