 ...
 * Apps) login to a gated Clara gateway: system-browser + loopback redirect +
 ...
 * upstream IDP (Clara Portal) issues a per-gateway-instance client_id and only
...
// clara_cli/web_server.py status handler.
