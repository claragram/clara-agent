...
function expectRequestHeaders(
  ...
  applyRemoteRequestHeaders({ url, requestHeaders: { Origin: 'app://clara' } }, callback, store.headersFor)

  expect(callback).toHaveBeenCalledOnce()
  expect(callback).toHaveBeenCalledWith(expected ? { requestHeaders: { Origin: 'app://clara', ...expected } } : {})
}
