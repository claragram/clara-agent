...
// by main.ts (`setBackgroundThrottling` driven by the merged `clara:active-work`
...
// (the "Clara idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Clara" wake word has NO preceding click,
