...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\clara\clara-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@clara/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@clara/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@clara/shared': path.resolve(__dirname, '../shared/src'),
