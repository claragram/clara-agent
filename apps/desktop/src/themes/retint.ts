 ...
 * surfaces mixed from it. In `clara` that's 7 slots per mode —
 ...
 * literally — Clara blue `#0053FD` is 5.4:1 on GitHub's light sidebar but only
 ...
 * this accent get in dark mode" — clara's blues are OKLCH L 0.528 → 0.638 at the
