/**
 * Clara skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$CLARA_HOME/skins/` (or a
 * built-in) resolved by `clara_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Clara authors from a prompt lights up all three surfaces from one file.
 *
...
import type { ClaraSkin, SkinColors } from '@clara/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: ClaraSkin): DesktopTheme | null {
