...
function identityForConnection(connection: ClaraConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: ClaraConnection | null): void {
