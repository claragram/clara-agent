...
const POPOUT_STORAGE_KEY = 'clara.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'clara.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'clara.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'clara.desktop.composerPopout.position'
