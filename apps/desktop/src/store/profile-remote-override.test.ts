...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://clara.example.com:8443/x')).toBe('clara.example.com:8443')
    expect(remoteHostLabel('https://clara.example.com:443')).toBe('clara.example.com')
    expect(remoteHostLabel('http://clara.example.com:80')).toBe('clara.example.com')
  })
