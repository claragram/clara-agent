...
export interface PetInfo {
  ...
  // the Clara "run" activity state uses the in-place running row).
 ...
 * CLARA_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'clara.desktop.pet-roam.v1'
