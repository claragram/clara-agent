 ...
 * - It covers Clara too. "Off" from someone who has just closed a bubble means
...
const ENABLED_KEY = 'clara.desktop.tips.rotation.v1'

export const $tipsEnabled = persistentAtom(ENABLED_KEY, true, Codecs.bool)
export const $retiredTips = persistentAtom<string[]>('clara.desktop.tips.retired.v1', [], Codecs.stringArray)
export const $lastTipId = persistentAtom<null | string>('clara.desktop.tips.last.v1', null, Codecs.nullableText)
export const $nextTipAt = persistentAtom<null | number>(
  'clara.desktop.tips.next.v1',
  null,
