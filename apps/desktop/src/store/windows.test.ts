...
function installBridge(
  openSessionWindow?: Window['claraDesktop']['openSessionWindow'],
  openWindow?: Window['claraDesktop']['openWindow'],
  openBrowserWindow?: Window['claraDesktop']['openBrowserWindow']
) {
