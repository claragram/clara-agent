 ...
 * `<clara home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'clara.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'clara.desktop.disabledPlugins.v1'
