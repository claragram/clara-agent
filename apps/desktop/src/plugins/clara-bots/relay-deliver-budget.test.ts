...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/clara-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'clara_cli/config_defaults.py'), 'utf8')
