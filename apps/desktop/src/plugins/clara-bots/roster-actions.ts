...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@clara/plugin-sdk'
 ...
 *  (clara-agent#90102) and are discarded. Without `canonical_session` (older
