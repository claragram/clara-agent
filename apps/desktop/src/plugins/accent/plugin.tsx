...
import type { ClaraPlugin, PaletteContribution } from '@clara/plugin-sdk'
import { $accentOverride, PALETTE_AREA, setAccentOverride, STATUSBAR_AREAS } from '@clara/plugin-sdk'

import { AccentPickerTrigger } from './picker'

const plugin: ClaraPlugin = {
  id: 'accent',
  name: 'Accent Picker',
  description:
