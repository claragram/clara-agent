...
const STORAGE_KEY = 'clara.desktop.layoutTree.v2'

writeKey('clara.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('clara.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('clara.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'clara.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'clara.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'clara.desktop.hiddenStripTabs.v1'
...
writeKey('clara.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__CLARA_LAYOUT_TREE__ = {
    close: closeTreePane,
