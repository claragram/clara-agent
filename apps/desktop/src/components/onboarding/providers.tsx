...
const PROVIDER_DISPLAY: Record<string, { order: number; title: string }> = {
  clara: { order: 0, title: 'Clara Portal' },
...
export function FeaturedProviderRow({
  ...
  return (
    <button
      ...
      type="button"
    >
      <span aria-hidden className="arc-border arc-reverse arc-clara" />
...
/** Quick-key row for API-key providers (Fireworks leads the expanded list after Clara, OpenRouter further down). */
