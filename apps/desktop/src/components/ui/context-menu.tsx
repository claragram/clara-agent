...
export const CLARA_CONTEXT_MENU_TRIGGER_ATTR = 'data-clara-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-clara-context-menu-trigger="" />
  )
}
