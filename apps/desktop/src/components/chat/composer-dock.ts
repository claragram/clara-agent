 ...
 *  smallest type, soft clara shadow. Uses an explicit fill (not `--composer-fill`)
...
export const composerPanelCard = cn(
  'rounded-2xl border border-border/65 shadow-clara text-[length:var(--conversation-tool-font-size)]',
