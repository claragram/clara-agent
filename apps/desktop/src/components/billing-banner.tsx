 ...
 * usable — it only offers recovery: Clara opens Settings → Billing in-app, other
...
export function BillingBanner({ sessionId }: { sessionId: null | string }) {
  ...
  const title = block.is_clara ? copy.titleClara : copy.titleProvider(block.provider_label)
