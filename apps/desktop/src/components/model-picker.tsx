...
import { getLocalModelsStatus } from '@/clara'
...
import type { LocalModelLoadProgress, ModelOptionProvider, ModelPricing } from '@/types/clara'
...
export function ModelPickerDialog({
  ...
  // the `clara model` CLI picker, which shows the curated list verbatim.
...
function ProviderHeading({ provider }: { provider: ModelOptionProvider }) {
  ...
  // free_tier is only set for Clara. true → "Free tier", false → "Pro".
  const tierBadge =
