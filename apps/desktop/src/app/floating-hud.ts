...
// hairline `--stroke-clara` paired with the soft `--shadow-clara` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-clara) bg-(--ui-chat-bubble-background) shadow-clara [-webkit-app-region:no-drag]'
