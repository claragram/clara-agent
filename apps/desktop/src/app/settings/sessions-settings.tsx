...
import type { ClaraConfigRecord, SessionInfo } from '@/types/clara'
...
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.claraDesktop` is
    ...
    const settings = window.claraDesktop?.settings
