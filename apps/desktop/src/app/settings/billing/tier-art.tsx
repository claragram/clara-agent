...
// over a solid Clara-blue well and blends into it. This blue well is the ONLY place
// Clara blue appears in the billing page — everything else stays on the app's own tokens.
const CLARA_BLUE = '#0000f2'
...
/**
 * Small rounded thumbnail (~40px) rendering the tier art over a Clara-blue well.
...
export function TierArt({ className, name, size = 40 }: { className?: string; name?: null | string; size?: number }) {
  ...
  return (
    <div
      ...
      style={{ background: CLARA_BLUE, height: size, width: size }}
    >
      <img
        alt=""
