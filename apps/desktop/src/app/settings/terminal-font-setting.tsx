...
function fontFamilyFromConfig(config: ClaraConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useClaraConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<ClaraConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setClaraConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="clara-terminal-font-families"
          ...
          <datalist id="clara-terminal-font-families">
