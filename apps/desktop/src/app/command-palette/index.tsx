...
import { getClaraConfigRecord, listAllProfileSessions } from '@/clara'
...
// Clara session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-clara',
            keywords: ['update', 'upgrade', 'clara', 'version', 'system', 'restart'],
            label: cc.updateClara,
  ...
  const searchGroups = useMemo<PaletteGroup[]>(() => {
    ...
    // Apply a theme directly from the root search (e.g. "clara" → Clara). Live
