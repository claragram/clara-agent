...
// subscriber __PROT_1_synchroclaraly__ — that reaches the @/store/gateway mock's
...
vi.mock('@/store/gateway', () => ({
  ...
  // atom plus the hoisted activeGateway so the __PROT_0_synchroclara__ subscriber doesn't
