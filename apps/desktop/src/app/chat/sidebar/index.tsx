...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/clara'
...
// highlight markers (sqlite snippet() delimiters — see clara_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('clara:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('clara:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Clara to
