...
import type { ClaraGitBranch } from '@/global'
...
const branchActionLabel = (branch: ClaraGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<ClaraGitBranch[]>([])
  ...
  const convert = async (branch: ClaraGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
