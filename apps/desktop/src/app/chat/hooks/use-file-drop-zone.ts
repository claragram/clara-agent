...
import { type DroppedFile, extractDroppedFiles, CLARA_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, CLARA_PATHS_MIME) ? 'files' : null
