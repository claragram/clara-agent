 ...
 * (threshold, rAF moves, snapshots, Esc-as-top-layer with __PROT_0_synchroclara__
...
export function startSessionDrag(
  ...
  // The drag SOURCE (sidebar row or tile tab). Captured __PROT_1_synchroclaraly__ — React
