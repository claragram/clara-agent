...
const TAKEOVER_KEY = 'clara.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Clara can't clear via the API — the user
 *  sees exactly what runs instead of Clara silently deleting their creds. */
