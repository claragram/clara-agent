import type { ClaraReviewFile } from '@/global'
...
export function buildReviewFlatList(files: ClaraReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: ClaraReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
