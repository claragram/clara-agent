...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/clara-agent')).toBe('~/www/clara-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/clara-agent')).toBe('clara-agent')
    expect(pathLeaf('~/www/clara-agent')).toBe('clara-agent')
