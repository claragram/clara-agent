...
/** Clara' reasoning levels, in ascending order — mirrors the backend's
 *  VALID_REASONING_EFFORTS (clara_constants.py). `none` is not a level: it's
...
/** Clara' built-in level when neither the surface nor the profile config
