...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|clara):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.claraDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.claraDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Clara, and it is the surface the agent
