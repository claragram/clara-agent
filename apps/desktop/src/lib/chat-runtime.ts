...
import type { ModelOptionsResponse, SessionInfo } from '@/types/clara'
 ...
 *
 * Only the leading status prefix (e.g. "Clara is thinking...") and the
 ...
 *  resolved comment as JSON (ClaraPrComment shape); a malformed payload falls
