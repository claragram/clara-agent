 ...
 * plugins resolve `@clara/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __CLARA_PLUGIN_SDK__: sdk,
  __CLARA_REACT__: React,
  __CLARA_REACT_JSX__: jsxRuntime,
  __CLARA_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@clara/plugin-sdk': shimUrl('__CLARA_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__CLARA_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__CLARA_REACT_JSX__'),
    react: shimUrl('__CLARA_REACT__')
  }
