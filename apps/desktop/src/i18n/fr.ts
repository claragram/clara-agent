...
export const fr: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        'Clara n\'est pas installé sur l\'hôte distant. Installez-le là-bas (curl -fsSL https://agent.claraprise.com/install.sh | sh) ou spécifiez le chemin vers Clara.',
      sshErrPlatform:
  ...
  sidebar: {
    ...
    projects: {
      ...
      namePlaceholder: 'ex. Projet Claraprise',
