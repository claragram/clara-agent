      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via CLARA_BUNDLED_SKILLS /
            # CLARA_OPTIONAL_SKILLS (see clara-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + CLARA_BUNDLED_LOCALES
            # / CLARA_OPTIONAL_MCPS, not via the wheel. Excluding them
