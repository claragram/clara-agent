# nix/overlays.nix — Expose pkgs.clara-agent for external NixOS configs
#
...
# `pkgs.clara-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    clara-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
