...
benchmarked ten harnesses on hostile-file handling — and whose Clara column
...
Every task runs the full Clara agent (file + terminal + search toolsets)
...
Rules of engagement (from clarabench discipline):
