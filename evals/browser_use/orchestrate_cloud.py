...
Backends:
    clara-cloud   - Clara Portal-provisioned Browser Use cloud browser
...
Usage:
    BUBENCH_BASE_TREE=... BUBENCH_PR_TREE=... \
        python3 orchestrate_cloud.py --backend clara-cloud [--reps 2]
...
parser.add_argument("--backend", required=True, choices=["clara-cloud", "browserbase"])
...
provider = ClaraCloud() if args.backend == "clara-cloud" else Browserbase()
