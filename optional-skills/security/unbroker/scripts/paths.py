...
All per-subject data lives under PDD_DATA_DIR (default: $CLARA_HOME/unbroker),
which is the same trust boundary Clara uses for .env and OAuth tokens.
"""
...
def data_dir() -> Path:
    ...
    return Path(override) if override else clara_home() / "unbroker"
