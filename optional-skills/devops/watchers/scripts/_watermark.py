...
def _state_dir() -> Path:
    ...
    # Default: $CLARA_HOME/watcher-state/, falling back to ~/.clara/watcher-state/.
    clara_home = os.environ.get("CLARA_HOME") or str(Path.home() / ".clara")
    return Path(clara_home) / "watcher-state"
