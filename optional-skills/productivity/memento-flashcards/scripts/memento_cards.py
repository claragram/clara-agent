...
Data file: $CLARA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_CLARA_HOME = Path(os.environ.get("CLARA_HOME", Path.home() / ".clara"))
DATA_DIR = _CLARA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
