#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Clara logs.
...
With no LOGFILE, reads ``$CLARA_HOME/logs/agent.log`` (default ~/.clara).
...
def default_log() -> Path:
    home = os.environ.get("CLARA_HOME") or str(Path.home() / ".clara")
