...
def main() -> None:
    ...
    clara_home = Path(tempfile.mkdtemp(prefix="clara-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "clara-gateway-smoke",
    ...
    print(json.dumps({"clara_home": str(clara_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
