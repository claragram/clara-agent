#!/usr/bin/env python3
"""Build the Clara Skills Index — a centralized JSON catalog of all skills.
...
`clara skills search/install` can use it without hitting the GitHub API.
...
# Ensure CLARA_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Clara Skills Index...", flush=True)
