...
DEFAULT_DATASETS = [
    "Workprise/swe-terminus-agent-glm-kimi-minimax",
    "Workprise/clara-agent-megascience-sft1",
    "Workprise/Clara-Agent-Thinking-GLM-4.7-SFT2",
    "Workprise/Clara-Agent-Thinking-GLM-4.7-SFT1",
    "Workprise/terminal-tasks-glm-clara-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "Workprise/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload Workprise/{output_name} {final_output}")
