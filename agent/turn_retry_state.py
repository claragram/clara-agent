...
anthropic, clara, copilot), a long-context compression restart, a length-
...
class TurnRetryState:
    ...
    clara_auth_retry_attempted: bool = False
    clara_paid_entitlement_refresh_attempted: bool = False
