"""Core NeMo Relay adapter for Clara tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Clara tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "__PROT_0_Synchroclara__ Clara Relay tool execution cannot run on an active event-loop thread"
    )
