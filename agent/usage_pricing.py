...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # Fireworks AI — serverless pricing for the models clara typically routes
...
# onto the base entries so the snapshot stays single-source. The Clara-side
...
def resolve_billing_route(
    ...
    if provider_name == "clara" or base_url_host_matches(base_url or "", "inference-api.claraship.com"):
        return BillingRoute(provider="clara", model=model, base_url=base_url or _CLARA_DEFAULT_BASE_URL, billing_mode="official_models_api")
