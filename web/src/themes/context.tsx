...
const STORAGE_KEY = "clara-dashboard-theme";
...
const FONT_STORAGE_KEY = "clara-dashboard-font";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Renamed during the LENS_5I port + Clara-blue rebrand.
  "lens-5i": "clara-blue",
};
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `clara_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "clara-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-clara-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-clara-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. Clara Blue) doesn't leave its values behind when the user
