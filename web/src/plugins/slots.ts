 ...
 * `window.__CLARA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Clara brand in the top bar
 ...
 *  `window.__CLARA_PLUGINS__.registerSlot(...)`.
 *
