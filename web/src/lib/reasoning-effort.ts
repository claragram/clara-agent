 ...
 *
 * Values mirror clara_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Clara default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Clara' default when unset). */
