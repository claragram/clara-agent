...
const PROVIDER_GROUPS: { prefix: string; name: string; priority: number }[] = [
  // Clara Portal first
  { prefix: "CLARA_", name: "Clara Portal", priority: 0 },
  // Then alphabetical by display name
  { prefix: "ANTHROPIC_", name: "Anthropic", priority: 1 },
  { prefix: "DASHSCOPE_", name: "DashScope (Qwen)", priority: 2 },
  { prefix: "CLARA_QWEN_", name: "DashScope (Qwen)", priority: 2 },
...
// Mirror of the backend env-name guard (clara_cli/config.py _ENV_VAR_NAME_RE).
      ...
      <div className="flex items-center justify-between">
        <div className="flex flex-col gap-1">
          <p className="text-sm text-muted-foreground">
            {t.env.description} <code>~/.clara/.env</code>
          </p>
