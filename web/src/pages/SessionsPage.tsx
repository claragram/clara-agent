...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    clara_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__clara_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id, rowProfile(id)), {
          ...
          headers: {
            "X-Clara-Session-Token":
              (window as unknown as { __CLARA_SESSION_TOKEN__?: string })
                .__CLARA_SESSION_TOKEN__ ?? "",
          },
        });
