...
Only included in the clara-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Clara-Agent (https://github.com/claraprise/clara-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_clara_home() / "cache" / "discord_capabilities.json"
