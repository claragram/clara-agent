...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of claraship/clara-agent#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of claraship/clara-agent#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (claraship/clara-agent#67052). ``ok`` stays
