...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of Workprise/clara-agent#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of Workprise/clara-agent#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (Workprise/clara-agent#67052). ``ok`` stays
