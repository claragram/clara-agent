...
or change arbitrary Clara configuration.
...
small host fact requested by the RFC. Settings writes use Clara'
...
`CLARA_HOME`, so one globally loaded plugin context follows multiplexed
...
```text
<CLARA_HOME>/plugin-data/<plugin-data-namespace>/state.json
```
...
The implementation is covered with real temporary-Clara-home tests for:
...
- [Issue #64227](https://github.com/claraship/clara-agent/issues/64227)
- [RFC PR #58542](https://github.com/claraship/clara-agent/pull/58542) by Topher Ross
