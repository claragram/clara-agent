...
def make_clara_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated CLARA_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"clara-home-{journal_mode}"
