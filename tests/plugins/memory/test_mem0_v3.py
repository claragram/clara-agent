...
class TestMem0Prefetch:
    """prefetch() must recall on the CURRENT question, __PROT_1_synchroclaraly__.
    ...
    def test_queue_prefetch_fires_no_search(self):
        # prefetch is __PROT_0_synchroclara__ now, so the post-turn warm is redundant and
