...
Damien's incident (Discord, 2026-05-28): a long Clara session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``clara_state`` module, whose ``SessionDB``
    ...
    namespace = {"__name__": "clara_state"}
    source = '''
class SessionDB:
...
_NominalSessionDBImpostor.__module__ = "clara_state"
