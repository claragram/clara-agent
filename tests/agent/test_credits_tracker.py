...
def _base_headers(**overrides) -> dict:
    ...
    h = {
        "x-clara-credits-version": "1",
        "x-clara-credits-remaining-micros": micros(0),
        "x-clara-credits-remaining-usd": "0.00",
        "x-clara-credits-subscription-micros": micros(0),
        "x-clara-credits-subscription-usd": "0.00",
        "x-clara-credits-rollover-micros": micros(0),
        "x-clara-credits-purchased-micros": micros(0),
        "x-clara-credits-purchased-usd": "0.00",
        "x-clara-tool-pool-micros": micros(0),
        "x-clara-tool-pool-gated-off": "false",
        "x-clara-credits-denominator-kind": "none",
        "x-clara-credits-paid-access": "true",
        "x-clara-credits-as-of-ms": "1717000000000",
    }
    h.update(overrides)
    return h
...
HEALTHY_HEADERS = _base_headers(
    **{
        "x-clara-credits-remaining-micros": micros(30.34),
        "x-clara-credits-remaining-usd": "30.34",
        "x-clara-credits-subscription-micros": micros(18.00),
        "x-clara-credits-subscription-usd": "18.00",
        "x-clara-credits-subscription-limit-micros": micros(20.00),
        "x-clara-credits-subscription-limit-usd": "20.00",
        "x-clara-credits-rollover-micros": micros(0),
        "x-clara-credits-purchased-micros": micros(12.34),
        "x-clara-credits-purchased-usd": "12.34",
        "x-clara-tool-pool-micros": micros(2.00),
        "x-clara-tool-pool-gated-off": "true",
        "x-clara-credits-denominator-kind": "subscription_cap",
        "x-clara-credits-paid-access": "true",
    }
)
...
SUB_90PCT_HEADERS = _base_headers(
    **{
        "x-clara-credits-remaining-micros": micros(2.00),
        "x-clara-credits-remaining-usd": "2.00",
        "x-clara-credits-subscription-micros": micros(2.00),
        "x-clara-credits-subscription-usd": "2.00",
        "x-clara-credits-subscription-limit-micros": micros(20.00),
        "x-clara-credits-subscription-limit-usd": "20.00",
        "x-clara-credits-purchased-micros": micros(0),
        "x-clara-credits-purchased-usd": "0.00",
...
GRANT_EXHAUSTED_HEADERS = _base_headers(
    **{
        "x-clara-credits-remaining-micros": micros(12.34),
        "x-clara-credits-remaining-usd": "12.34",
        "x-clara-credits-subscription-micros": micros(0),
        "x-clara-credits-subscription-usd": "0.00",
        "x-clara-credits-subscription-limit-micros": micros(20.00),
        "x-clara-credits-subscription-limit-usd": "20.00",
...
PURCHASED_ONLY_HEADERS = _base_headers(
    **{
        "x-clara-credits-remaining-micros": micros(30.00),
        "x-clara-credits-remaining-usd": "30.00",
        "x-clara-credits-subscription-micros": micros(0),
        "x-clara-credits-subscription-usd": "0.00",
        "x-clara-credits-purchased-micros": micros(30.00),
        "x-clara-credits-purchased-usd": "30.00",
        "x-clara-credits-denominator-kind": "none",
        "x-clara-credits-paid-access": "true",
...
TOOL_POOL_FREE_HEADERS = _base_headers(
    **{
        "x-clara-credits-remaining-micros": micros(0.05),
        "x-clara-credits-remaining-usd": "0.05",
        "x-clara-tool-pool-micros": micros(0.05),
        "x-clara-tool-pool-gated-off": "false",
        "x-clara-credits-paid-access": "true",
    }
)
...
DEPLETED_HEADERS = _base_headers(
    **{
        ...
        "x-clara-credits-purchased-micros": micros(0),
        "x-clara-credits-purchased-usd": "0.00",
        "x-clara-credits-paid-access": "false",
        "x-clara-credits-disabled-reason": "out_of_credits",
    }
)
...
DEBT_HEADERS = _base_headers(
    **{
        "x-clara-credits-remaining-micros": micros(0),
        "x-clara-credits-remaining-usd": "0.00",
        "x-clara-credits-subscription-micros": str(-5_000_000),
        "x-clara-credits-subscription-usd": "-5.00",
        "x-clara-credits-purchased-micros": micros(0),
        "x-clara-credits-purchased-usd": "0.00",
        "x-clara-credits-paid-access": "false",
    }
...
class TestVersionValidation:
    def test_version_string_1_parses(self):
        headers = _base_headers(**{"x-clara-credits-version": "1"})
        state = parse_credits_headers(headers)
        assert state is not None
    ...
    def test_version_greater_than_1_warns_once(self, caplog):
        ...
        try:
            ...
            headers = _base_headers(**{"x-clara-credits-version": "3"})
...
class TestBoolStringTrap:
    ...
    def test_paid_access_string_false_means_depleted(self):
        ...
        headers = _base_headers(**{"x-clara-credits-paid-access": "false"})
        state = parse_credits_headers(headers)
        assert state is not None
        assert state.paid_access is False
        assert state.depleted is True
    ...
    def test_paid_access_string_true_means_not_depleted(self):
        headers = _base_headers(**{"x-clara-credits-paid-access": "true"})
        state = parse_credits_headers(headers)
        assert state is not None
        assert state.paid_access is True
        assert state.depleted is False
...
class TestToolPoolOptional:
    """x-clara-tool-pool-* headers are optional; absent → defaults; present-but-malformed → miss."""

    def _no_tool_pool_headers(self) -> dict:
        """Base headers with BOTH tool-pool headers removed."""
        h = _base_headers()
        h.pop("x-clara-tool-pool-micros", None)
        h.pop("x-clara-tool-pool-gated-off", None)
        return h
...
class TestHalfPairLimit:
    ...
    def test_full_pair_present_parsed_correctly(self):
        ...
        headers = _base_headers(
            **{
                "x-clara-credits-subscription-micros": micros(10.00),
                "x-clara-credits-subscription-usd": "10.00",
                "x-clara-credits-subscription-limit-micros": micros(20.00),
                "x-clara-credits-subscription-limit-usd": "20.00",
                "x-clara-credits-denominator-kind": "subscription_cap",
            }
...
class TestNegativeValues:
    def test_negative_remaining_micros_returns_none(self):
        headers = _base_headers(**{"x-clara-credits-remaining-micros": "-1000"})
        assert parse_credits_headers(headers) is None
    ...
    def test_negative_limit_micros_returns_none(self):
        headers = _base_headers(
            **{
                "x-clara-credits-subscription-limit-micros": "-1000",
                "x-clara-credits-subscription-limit-usd": "-0.00",
                "x-clara-credits-denominator-kind": "subscription_cap",
            }
        )
        assert parse_credits_headers(headers) is None
    ...
    def test_negative_subscription_accepted(self):
        ...
        headers = _base_headers(**{"x-clara-credits-subscription-micros": "-5000000",
                                   "x-clara-credits-subscription-usd": "-5.00"})
        state = parse_credits_headers(headers)
        assert state is not None
...
class TestUsdValidation:
    def test_valid_usd_format(self):
        headers = _base_headers(**{"x-clara-credits-remaining-usd": "18.00"})
        state = parse_credits_headers(headers)
        assert state is not None
    ...
    def test_usd_one_decimal_returns_none(self):
        ...
        headers = _base_headers(**{"x-clara-credits-remaining-usd": "18.0"})
        assert parse_credits_headers(headers) is None
    ...
    def test_usd_negative_valid(self):
        ...
        headers = _base_headers(
            **{
                "x-clara-credits-subscription-micros": "-5000000",
                "x-clara-credits-subscription-usd": "-5.00",
            }
        )
        state = parse_credits_headers(headers)
...
class TestMicrosValidation:
    def test_non_int_micros_string_returns_none(self):
        headers = _base_headers(**{"x-clara-credits-remaining-micros": "abc"})
        assert parse_credits_headers(headers) is None
...
class TestAsOfMs:
    def test_junk_as_of_ms_returns_none(self):
        headers = _base_headers(**{"x-clara-credits-as-of-ms": "not-a-timestamp"})
        assert parse_credits_headers(headers) is None

    def test_valid_as_of_ms(self):
        headers = _base_headers(**{"x-clara-credits-as-of-ms": "1717000000000"})
        state = parse_credits_headers(headers)
        assert state is not None
...
class TestDenominatorKind:
    ...
    def test_none_valid(self):
        headers = _base_headers(**{"x-clara-credits-denominator-kind": "none"})
        state = parse_credits_headers(headers)
        assert state is not None
        assert state.denominator_kind == "none"

    def test_invalid_denominator_kind_returns_none(self):
        headers = _base_headers(**{"x-clara-credits-denominator-kind": "invalid_kind"})
        assert parse_credits_headers(headers) is None
...
class TestZeroDivisionGuard:
    def test_subscription_limit_zero_used_fraction_is_none(self):
        ...
        headers = _base_headers(
            **{
                "x-clara-credits-subscription-limit-micros": "0",
                "x-clara-credits-subscription-limit-usd": "0.00",
                "x-clara-credits-denominator-kind": "subscription_cap",
            }
        )
...
class TestUnknownHeaders:
    def test_unknown_extra_header_ignored(self):
        headers = {
            **_base_headers(),
            "x-clara-credits-future-field": "some-value",
            "x-request-id": "abc123",
        }
        state = parse_credits_headers(headers)
        assert state is not None
...
class TestHeaderNormalization:
    ...
    def test_mixed_case_headers_parsed(self):
        headers = {
            "X-Clara-Credits-Version": "1",
            "X-Clara-Credits-Remaining-Micros": micros(5.00),
            "X-Clara-Credits-Remaining-Usd": "5.00",
            "X-Clara-Credits-Subscription-Micros": micros(5.00),
            "X-Clara-Credits-Subscription-Usd": "5.00",
            "X-Clara-Credits-Rollover-Micros": "0",
            "X-Clara-Credits-Purchased-Micros": "0",
            "X-Clara-Credits-Purchased-Usd": "0.00",
            "X-Clara-Tool-Pool-Micros": "0",
            "X-Clara-Tool-Pool-Gated-Off": "false",
            "X-Clara-Credits-Denominator-Kind": "none",
            "X-Clara-Credits-Paid-Access": "true",
            "X-Clara-Credits-As-Of-Ms": "1717000000000",
