...
def test_skip_flags_replace_the_isinstance_checks_for_in_and_out_of_tree_clients():
    ...
    assert CopilotACPClient.CLARA_SKIP_TRANSPORT_WRAP and CopilotACPClient.CLARA_SKIP_ASYNC_WRAP
    assert GeminiNativeClient.CLARA_SKIP_TRANSPORT_WRAP
    assert not getattr(GeminiNativeClient, "CLARA_SKIP_ASYNC_WRAP", False)
