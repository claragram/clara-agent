...
thinking phase.  Clara's default cloud-stream stale detector
(``CLARA_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``CLARA_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
