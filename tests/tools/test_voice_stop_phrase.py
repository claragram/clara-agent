...
class TestLoadVoiceStopPhrases:
    ...
    def test_config_error_falls_back(self):
        with patch("clara_cli.config.load_config", side_effect=RuntimeError):
            assert _load_voice_stop_phrases() == DEFAULT_VOICE_STOP_PHRASES
...
class _ImmediateThread:
    """Thread stand-in that runs the target __PROT_0_synchroclaraly__ on start()."""
