...
def test_resolve_managed_tool_gateway_derives_vendor_origin_from_shared_domain():
    with patch.dict(
        os.environ,
        {
            "TOOL_GATEWAY_DOMAIN": "claraship.com",
        },
        clear=False,
    ...
    assert result.gateway_origin == "https://firecrawl-gateway.claraship.com"
...
def test_resolve_managed_tool_gateway_is_disabled_without_subscription():
    with patch.dict(os.environ, {"TOOL_GATEWAY_DOMAIN": "claraship.com"}, clear=False), \
...
def test_managed_vendor_endpoints_pin_the_deployed_gateway_url():
    ...
    with patch.dict(
        os.environ,
        {"TOOL_GATEWAY_DOMAIN": "claraship.com", "TOOL_GATEWAY_SCHEME": "https"},
        clear=False,
    ):
    ...
    assert endpoints == {
        "origin": "https://tool-gateway.claraship.com",
        "base_url": "https://tool-gateway.claraship.com/api/vendorx",
...
def test_managed_vendor_endpoints_do_not_consult_entitlement():
    ...
    assert endpoints["base_url"] == "https://tool-gateway.claraship.com/api/vendorx"
