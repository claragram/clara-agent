...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("CLARA_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("CLARA_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("CLARA_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
