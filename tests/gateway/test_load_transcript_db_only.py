...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.clara/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at clara_state import time, before pytest's CLARA_HOME monkeypatch
    fires — the autouse fixture's CLARA_HOME override doesn't help here.)
    """
    import clara_state
