"""Tests for _setup_feishu() in clara_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("clara_cli.config.save_env_value", side_effect=mock_save), \
         patch("clara_cli.config.get_env_value", side_effect=mock_get), \
         patch("clara_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("clara_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("clara_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("clara_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("clara_cli.cli_output.print_header"), \
         patch("clara_cli.cli_output.print_info"), \
         patch("clara_cli.cli_output.print_success"), \
         patch("clara_cli.cli_output.print_warning"), \
         patch("clara_cli.cli_output.print_error"), \
