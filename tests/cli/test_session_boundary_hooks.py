...
from clara_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/clara_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("clara_cli.lifecycle.invoke_hook")
@patch("clara_cli.lifecycle.finalize_session")
