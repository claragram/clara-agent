"""Regression test: clara update must not load cryptography eagerly."""
...
assert 'clara_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running clara update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so clara_cli is importable,
...
import clara_cli.main
from clara_cli.update_cmd import _cmd_update_check
