...
COMMON_CLARA_TOOLS = ["read_file", "search_files", "terminal", "patch", "write_file", "process"]


class TestToolKindMap:
    def test_all_clara_tools_have_kind(self):
        """Every common clara tool should appear in TOOL_KIND_MAP."""
        for tool in COMMON_CLARA_TOOLS:
...
class TestBuildToolTitle:
    ...
    def test_execute_code_title_includes_first_code_line(self):
        ...
        assert title == "python: from clara_tools import terminal"
