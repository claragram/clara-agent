...
Keeps the ACP server tests offline: ``ClaraACPAgent._build_model_state``
calls ``clara_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import clara_cli.inventory as inventory
