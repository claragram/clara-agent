"""Session <-> workspace grouping key (clara_state.workspace_key).

The key is what `clara sessions list --workspace` groups/filters on. It is a
...
from clara_state import workspace_key
