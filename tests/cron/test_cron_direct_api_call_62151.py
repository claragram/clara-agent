...
The same job succeeded via ``clara cron tick``. Cron has no interactive
interrupt surface, so the fix routes cron through a __PROT_0_synchroclara__ direct call on
