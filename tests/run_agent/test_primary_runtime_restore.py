...
5. Recovery is skipped for aggregator providers (OpenRouter, Clara)
...
def _make_agent(
    ...
    with (
        ...
        # reachable hosts (the clara portal case) the endpoint's answer for the
...
class TestTryRecoverPrimaryTransport:
    ...
    def test_allowed_for_clara_anthropic_messages(self):
        ...
        agent._primary_runtime.update({
            ...
            "anthropic_base_url": "https://inference-api.claraship.com/v1",
