...
The unit tests in tests/clara_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned clara-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/clara")
from clara_cli.service_manager import S6ServiceManager
