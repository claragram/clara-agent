...
Covers the shared prompt builder (clara_cli.init_command.build_init_prompt)
...
from clara_cli.init_command import (
    _QUALITY_BAR,
    build_init_prompt,
...
class TestInitRegistryWiring:
    ...
    def test_init_works_on_the_gateway(self):
        ...
        from clara_cli.commands import GATEWAY_KNOWN_COMMANDS
