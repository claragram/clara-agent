...
Run before any catalog commit:
    ...
    CLARA_TEST_NETWORK=1 scripts/run_tests.sh tests/clara_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("CLARA_TEST_NETWORK"),
    reason="network test; set CLARA_TEST_NETWORK=1 to run",
)
