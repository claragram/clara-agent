...
from clara_cli.web_server import _open_session_db_at_path
from clara_state import SessionDB, _db_fingerprint
...
def test_poll_observes_a_replaced_state_db(tmp_path):
    ...
    # `clara sessions recover` writes a clean database, which the operator
