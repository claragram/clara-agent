"""Tests for the shared tar.gz writer (``clara_cli.archive_safe.make_targz``).

``make_targz`` backs both ``clara profile export`` and ``clara kanban
...
from clara_cli.archive_safe import make_targz
