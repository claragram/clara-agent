...
class TestValidatorRules:
    ...
    def test_default_inference_url_is_in_allowlist(self):
        ...
        ``inference-api.claraship.com``, they MUST update the allowlist
...
class TestHealsPoisonedStoredValue:
    ...
    stale ``stg-inference-api.claraship.com`` persisted before the
    ...
    def test_refresh_resets_rejected_url_to_default(self, monkeypatch):
        ...
        poisoned = "https://stg-inference-api.claraship.com/v1"
        state = {
            "access_token": "tok",
            "refresh_token": "rtok",
            "client_id": "clara-cli",
...
class TestEnvOverrideWins:
    ...
    STAGING = "https://stg-inference-api.claraship.com/v1"
