...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`clara_cli.slash_exec.EXECUTORS`, and
...
from clara_cli.commands import COMMAND_REGISTRY, resolve_command
from clara_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
