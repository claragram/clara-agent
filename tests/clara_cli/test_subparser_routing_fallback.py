...
The main() function in clara_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `clara -c model`
...
def _build_parser():
    """Build a minimal replica of the clara top-level parser."""
