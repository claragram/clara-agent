...
class TestStatusEndpointTopology:
    ...
    def _setup_client(self, monkeypatch, _isolate_clara_home):
        try:
    ...
    def test_profile_names_and_mode_public_when_auth_gated(self, monkeypatch):
        ...
        # Clara Cloud Portal reads /api/status over the network (a gated bind)
        ...
        try:
            ...
            # alongside clara_home / gateway_pid.
            assert "gateways" not in data
            assert "clara_home" not in data
