"""Tests for `_can_open_graphical_browser()` in clara_cli.auth.

Guards the fix for the May 2026 report where `clara auth add xai-oauth`
...
from clara_cli.auth import _can_open_graphical_browser
