"""Tests for `clara chat --safe-mode` isolation."""
...
_VARS = ("CLARA_SAFE_MODE", "CLARA_IGNORE_USER_CONFIG", "CLARA_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["CLARA_SAFE_MODE"] == "1"
        assert os.environ["CLARA_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["CLARA_IGNORE_RULES"] == "1"
        return True
