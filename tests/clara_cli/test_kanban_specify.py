"""Tests for the specifier module + `clara kanban specify` CLI surface.
...
from clara_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `clara kanban …` argparse surface directly."""
