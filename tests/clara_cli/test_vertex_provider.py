...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (clara_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_clara_overlays():
    """clara_cli.providers.get_provider("vertex") backs
