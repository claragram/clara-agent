...
class TestConfigWriting:
    ...
    def test_plugin_provider_active_overrides_managed_clara_active_label(self, monkeypatch):
        from clara_cli import tools_config
        ...
        monkeypatch.setattr(
            ...
            lambda config, **kwargs: SimpleNamespace(
                features={"image_gen": SimpleNamespace(managed_by_clara=True)}
            ),
        )
        ...
        assert tools_config._is_provider_active(clara_row, config) is False
