...
class TestGetCopilotModelContext:
    ...
    @patch("clara_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("clara_cli.models._urlopen_model_catalog_request")
    ...
    @patch("clara_cli.models.fetch_github_model_catalog", return_value=[])
