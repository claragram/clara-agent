"""Tests for the interactive session browser (`clara sessions browse`).
...
from clara_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """clara sessions browse should be parseable."""
