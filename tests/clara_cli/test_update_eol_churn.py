"""Regression: ``clara update`` should take a managed checkout off autocrlf=true.
...
``clara update`` has to repair them.
...
from clara_cli.update_cmd import _normalize_managed_eol
