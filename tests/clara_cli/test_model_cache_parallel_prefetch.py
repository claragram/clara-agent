...
# ---------------------------------------------------------------------------
# Thread-safe cache entry update (clara_cli/models.py)
# ---------------------------------------------------------------------------
...
class TestUpdateProviderCacheEntry:
    ...
    def test_writes_new_entry(self, tmp_path, monkeypatch):
        ...
        import clara_cli.models as mod
...
# ---------------------------------------------------------------------------
# Parallel prefetch (clara_cli/model_switch.py)
# ---------------------------------------------------------------------------
...
class TestPrefetchProviderModelsParallel:
    ...
    def test_skips_all_fresh_entries(self, monkeypatch):
        ...
        from clara_cli.model_switch import _prefetch_provider_models_parallel
        ...
        with patch("clara_cli.models._load_provider_models_cache", return_value=fresh_cache), \
             patch("clara_cli.models._credential_fingerprint", return_value="fp"), \
             patch("clara_cli.models.cached_provider_model_ids") as fetch:
    ...
    def test_fetches_only_stale_entries(self, monkeypatch):
        ...
        with patch("clara_cli.models._load_provider_models_cache", return_value=cache), \
             patch("clara_cli.models._credential_fingerprint", return_value="fp_f"), \
             patch("clara_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("clara_cli.models.update_provider_cache_entry"):
    ...
    def test_fetches_in_parallel(self, monkeypatch):
        ...
        with patch("clara_cli.models._load_provider_models_cache", return_value={}), \
             patch("clara_cli.models._credential_fingerprint", return_value="fp"), \
             patch("clara_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("clara_cli.models.update_provider_cache_entry"):
    ...
    def test_empty_list_is_noop(self):
        ...
        with patch("clara_cli.models.cached_provider_model_ids") as fetch:
