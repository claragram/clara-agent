...
def test_free_model_gets_flat_100_percent_discount():
    ...
    # "0.0000000000" strings (Clara portal shape) count as free too.
...
def test_fetch_models_with_pricing_copies_nested_original(monkeypatch):
    ...
    # Clara Portal opts in via include_sale_original=True.
...
def test_resolve_clara_pricing_credentials_honors_inference_env_override(monkeypatch):
    """Staging profiles set CLARA_INFERENCE_BASE_URL — pricing must follow it.
    ...
    monkeypatch.setenv(
        ...
        "https://stg-inference-api.claraship.com/v1",
    )
    ...
    api_key, base_url = models_mod._resolve_clara_pricing_credentials()
    assert api_key == ""
    ...
    assert base_url == "https://stg-inference-api.claraship.com"
...
def test_resolve_clara_pricing_credentials_normalizes_either_suffix(monkeypatch):
    ...
    for override in (
        "https://stg-inference-api.claraship.com",
        "https://stg-inference-api.claraship.com/",
        "https://stg-inference-api.claraship.com/v1",
        "https://stg-inference-api.claraship.com/v1/",
    ):
