"""Tests for ``clara approvals suggest`` (clara_cli/approvals_suggest.py).

Approval history in Clara is implied, not ledgered: the session DB
...
from clara_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
