"""Tests for `clara secrets bitwarden token` / `clara secrets onepassword token`.
...
from clara_cli import onepassword_secrets_cli as op_cli
from clara_cli import secrets_cli as bw_cli
