"""Unit tests for clara_cli.managed_scope (resolver + loaders + key helpers)."""
import textwrap
...
def test_managed_dir_env_scrubbed_by_default():
    """conftest must scrub CLARA_MANAGED_DIR so a dev-shell value can't leak in."""
    import os

    assert "CLARA_MANAGED_DIR" not in os.environ
