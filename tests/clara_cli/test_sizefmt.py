"""Tests for the shared byte formatter (clara_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from clara_cli.backup import _format_size as backup
    from clara_cli.checkpoints import _fmt_bytes as checkpoints
    from clara_cli.doctor import _human_bytes as doctor
