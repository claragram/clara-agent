...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and clara-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # clara-agent (tests/skills/)
]
