"""The `clara-agent` skill is what a running Clara knows about itself.

`website/` is never packaged, so an installed Clara has no local copy of the
user guide; skills ARE synced into `$CLARA_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Clara can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "clara-agent"
